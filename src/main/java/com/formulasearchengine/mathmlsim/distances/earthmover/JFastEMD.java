...
public class JFastEMD {
    ...
    static private long emdHatImplLongLongInt(java.util.Vector<Long> Pc, java.util.Vector<Long> Qc,
        ...
        java.util.Vector<java.util.List<Edge>> c = new java.util.Vector<java.util.List<Edge>>();
        for (int i = 0; i < b.size(); i++) {
            c.add(new java.util.LinkedList<com.formulasearchengine.mathmlsim.distances.earthmover.Edge>());
        }
        for (int i = 0; i < N; i++) {
            if (b.get(i) == 0) {
                continue;
        ...
        for (int i = 0; i < bb.size(); i++) {
            cc.add(new java.util.LinkedList<com.formulasearchengine.mathmlsim.distances.earthmover.Edge>());
        }
        ...
        java.util.Vector<java.util.List<Edge0>> flows = new java.util.Vector<java.util.List<Edge0>>(bb.size());
        for (int i = 0; i < bb.size(); i++) {
            flows.add(new java.util.LinkedList<com.formulasearchengine.mathmlsim.distances.earthmover.Edge0>());
        }
    ...
    static private double emdHat(java.util.Vector<Double> P, java.util.Vector<Double> Q, java.util.Vector<java.util.Vector<Double>> C,
