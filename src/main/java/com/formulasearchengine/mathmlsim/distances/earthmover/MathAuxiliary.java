...
class MinCostFlow {
    ...
    int numNodes;
    java.util.Vector<Integer> nodesToQ;

    // e - supply(positive) and demand(negative).
    // c[i] - edges that goes from node i. first is the second nod
    // x - the flow is returned in it
    long compute(java.util.Vector<Long> e, java.util.Vector<java.util.List<Edge>> c, java.util.Vector<java.util.List<Edge0>> x) {
        ...
        java.util.Vector<java.util.List<Edge1>> rCostForward = new java.util.Vector<java.util.List<Edge1>>();
        for (int i = 0; i < numNodes; i++) {
            rCostForward.add(new java.util.LinkedList<com.formulasearchengine.mathmlsim.distances.earthmover.Edge1>());
        }
        for (int from = 0; from < numNodes; ++from) {
            for (Edge it : c.get(from)) {
        ...
        // also zero
        java.util.Vector<java.util.List<Edge2>> rCostCapBackward = new java.util.Vector<java.util.List<Edge2>>();
        for (int i = 0; i < numNodes; i++) {
            rCostCapBackward.add(new java.util.LinkedList<com.formulasearchengine.mathmlsim.distances.earthmover.Edge2>());
        }
        for (int from = 0; from < numNodes; ++from) {
            for (Edge it : c.get(from)) {
    ...
    void computeShortestPath(java.util.Vector<Long> d, java.util.Vector<Integer> prev,
                             int from, java.util.Vector<java.util.List<Edge1>> costForward,
                             java.util.Vector<java.util.List<Edge2>> costBackward, java.util.Vector<Long> e, int[] l) {
        // Making heap (all inf except 0, so we are saving comparisons...)
        java.util.Vector<com.formulasearchengine.mathmlsim.distances.earthmover.Edge3> Q = new java.util.Vector<com.formulasearchengine.mathmlsim.distances.earthmover.Edge3>();
        for (int i = 0; i < numNodes; i++) {
            Q.add(new Edge3());
        }
    ...
    void heapDecreaseKey(java.util.Vector<com.formulasearchengine.mathmlsim.distances.earthmover.Edge3> Q, java.util.Vector<Integer> nodes_to_Q,
                         int v, long alt) {
    ...
    void heapRemoveFirst(java.util.Vector<com.formulasearchengine.mathmlsim.distances.earthmover.Edge3> Q, java.util.Vector<Integer> nodes_to_Q) {
        swapHeap(Q, nodes_to_Q, 0, Q.size() - 1);
        Q.remove(Q.size() - 1);
        heapify(Q, nodes_to_Q, 0);
    }

    void heapify(java.util.Vector<com.formulasearchengine.mathmlsim.distances.earthmover.Edge3> Q, java.util.Vector<Integer> nodes_to_Q, int i) {
        do {
            // TODO: change to loop
            int l = LEFT(i);
            int r = RIGHT(i);
    ...
    void swapHeap(java.util.Vector<com.formulasearchengine.mathmlsim.distances.earthmover.Edge3> Q, java.util.Vector<Integer> nodesToQ, int i, int j) {
        Edge3 tmp = Q.get(i);
        Q.set(i, Q.get(j));
        Q.set(j, tmp);
